...
//This is a version of dialog used specifically for the hint overlay
...
var phoneCallSound = new Audio(phoneCall);

function playPhoneCallSound() {
    phoneCallSound = new Audio(phoneCall);
    phoneCallSound.play();
}
